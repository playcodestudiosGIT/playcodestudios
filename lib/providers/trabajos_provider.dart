...
class TrabajosProvider extends ChangeNotifier {
  List<Trabajo> _allList = [
    ...
    Trabajo(
        ...
        imgs: [
          'https://res.cloudinary.com/dyxt5lhzw/image/upload/v1699383052/assets/superstudio_zrda5w.png'
        ],
        description:
    ...
    Trabajo(
        ...
        imgs: [
          'https://res.cloudinary.com/dyxt5lhzw/image/upload/v1699383633/assets/sonata_del_pajarillo_pig6fr.png'
        ],
        description:
    ...
    Trabajo(
        ...
        imgs: [
          'https://res.cloudinary.com/dyxt5lhzw/image/upload/v1699383934/assets/tyc_d0ldah.png'
        ],
        description:
    ...
    Trabajo(
        ...
        imgs: [
          'https://res.cloudinary.com/dyxt5lhzw/image/upload/v1699384188/assets/chv_yy4kb8.png'
        ],
    ...
    Trabajo(
        ...
        imgs: [
          'https://res.cloudinary.com/dyxt5lhzw/image/upload/v1699387311/assets/jphome_ozhcg5.png'
        ],
        description:
